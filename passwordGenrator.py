...
if __name__ == '__main__':
    print('Password Must Conatin Atleast 6 Characters')
    a = int(input('Enter the Number of Characters : '))
    if a>=6:
        print(generate_random_password(random.randint(6, a), SEQUENCE))
    else:
        print("""
Enter Valid Number of Charecters.

In Order to Create Strong Password.
        """)